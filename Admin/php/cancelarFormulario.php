...
<body>
    ...
    <?php
        ...
        $conexion=$base->query("SELECT R.id_reservacion, C.nombre, telefono, email, R.fecha_ingreso, R.fecha_salida FROM reservacion R JOIN cliente C ON R.id_cliente=C.id_cliente");
    ?>
        ...
        <table border="0" align="center">
            ...
            <?php
                while($registro=$conexion->fetch(PDO::FETCH_OBJ)){
                    echo "<form action='cancelar.php' method='post'>"; //habra un formulario por cada tr
                    echo"<tr>";
                    $n=0;
                    ...
                    echo "<td><input type='submit' class='quitarMargen boton botonVerde' name='update' id='up' value='Cancelar'></td>";
                    echo "</tr>";
                    echo "</form>";
                }
            ?>
