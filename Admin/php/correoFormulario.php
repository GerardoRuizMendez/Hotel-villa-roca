...
<head>
    <meta charset="utf-8">
    <title>Enviar correo de confirmación</title>
        ...
        <table border="0" align="center">
            ...
            <?php
                while($registro=$conexion->fetch(PDO::FETCH_OBJ)){
                    echo "<form action='correo.php' method='post'>"; //habra un formulario por cada tr
                    echo"<tr>";
                    $n=0;
                    ...
                    echo "<td><input type='submit' class='quitarMargen boton botonVerde' name='update' id='up' value='Enviar correo'></td>";
                    echo "</tr>";
                    echo "</form>";
                }
            ?>
