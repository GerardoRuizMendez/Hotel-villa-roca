    ...
    ?>
        ...
        <table border="0" align="center">
            <tr>
                ...
                <td class="primera_fila">Diponibilidad</td>
            </tr>

            <?php
                while($registro=$conexion->fetch(PDO::FETCH_OBJ)){
                    echo "<form action='accionesHabitacion.php' method='post'>"; //habra un formulario por cada tr
                    echo"<tr>";
                    $n=0;
            ...
            ?>
                <form action='accionesHabitacion.php' method='post'>
                    <tr>
