...
<body>
    ...
    <?php
        ...
        $conexion=$base->query("SELECT * FROM tipo_habitacion");
    ?>

        <h1>CRUD (Tipo de habitaciones)</h1>
        <table border="0" align="center">
            ...
            <?php
                while($registro=$conexion->fetch(PDO::FETCH_OBJ)){
                    echo "<form action='accionesTipo.php' method='post'>"; //habra un formulario por cada tr
                    echo"<tr>";
                    $n=0;
            ...
            ?>
                <form action='accionesTipo.php' method='post'>
                    <tr>
